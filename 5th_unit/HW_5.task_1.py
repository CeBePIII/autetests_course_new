...
def letter_stat(our_str):
    """
    Функция возвращает словарь, в котором ключами являются буквы, поданной на вход строки, а значениями числа,
    соответствующие количеству повторений данной буквы в поданной на вход строке
    @our_str: Произвольная строка
    @letters_dict: Получившийся словарь
    """
    letter_dict = {}
    for key in our_str:
